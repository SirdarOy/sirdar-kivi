 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Sirdar KIVI
 * Plugin URI:        https://github.com/SirdarOy/sirdar-kivi
 * Description:       A plugin for displaying KIVI real estate system items in WordPress. This is a modification from Alma Media's original plugin, please see more info from the plugin page.
 * Version:           1.1.0
 * Author:            Sirdar Oy & Alma Medapartners Oy
